    ...
    render() {
        ...
        return (
            <BootstrapTable data={data} version="4">
                <TableHeaderColumn width='70px' dataSort={true} isKey dataField='id'>
                    #
                </TableHeaderColumn>
                <TableHeaderColumn width='130px' dataSort={true} dataField='begin'
                                   dataFormat={dateFormatter}>
                    {TR.DATE_TIME}
                </TableHeaderColumn>
                <TableHeaderColumn width='350px' dataSort={true} dataField='candidate'
                ...
                <TableHeaderColumn width='70px' dataField='actions'
